...
rclone copy -PL /beegfs/scratch/ric.cosr/pedrini.edoardo/project_edoardo/240531_scRNAseq_MSSpinal_Absinta/out \
gdrive_edo:work/analysis/HSR/absinta/scrnaseq/240531_scRNAseq_MSSpinal_Absinta/out
