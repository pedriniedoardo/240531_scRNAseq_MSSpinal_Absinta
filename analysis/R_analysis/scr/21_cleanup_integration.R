...
meta_vector <- dir("../../out/object/subclusters/") %>% str_subset("clean")
...
# save the object
saveRDS(sobj_total_h,"../../out/object/manualClean/20_sobj_integrated_cleanup.rds")