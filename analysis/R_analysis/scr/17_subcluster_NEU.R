# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the NEU cells from the WM+CX dataset
...
sobj_subset <- subset(sobj,subset = cell_id %in% c("NEU"))
...
saveRDS(sobj_total_h,"../../out/object/17_NEU_subcluster_HarmonySample.rds")
