...
ggsave("../../out/plot/UMAP_refSCShirmer.pdf",width = 10,height = 8)
ggsave("../../out/plot/UMAP_refSCShirmer.png",width = 10,height = 8,bg="white")
...
query <- readRDS("../../out/object/data.combined_harmonySkipIntegration_AllSoupX_00500_07000_05_AnnotationSCType.rds")

# fix the meta to add the general cell annotation
query$seurat_clusters_fix1 <- paste0("clu_",query$RNA_snn_res.0.1)
DimPlot(query,group.by = "seurat_clusters_fix1",label = T,raster = T)
ggsave("../../out/plot/UMAP_querySC.pdf",width = 10,height = 8)
ggsave("../../out/plot/UMAP_querySC.png",width = 10,height = 8,bg="white")
...
ggsave("../../out/plot/histo_prediction_label_transfer_refSCShirmer_querySC.pdf",width = 5,height = 4)
...
ggsave("../../out/plot/UMAP_label_transfer_refSCShirmer_querySC_raw.pdf",width = 10,height = 8)
ggsave("../../out/plot/UMAP_label_transfer_refSCShirmer_querySC_raw.png",width = 10,height = 8,bg="white")
...
ggplot(label= TRUE)+
  ...
  guides(colour = guide_legend(override.aes = list(size=5)))
ggsave("../../out/plot/UMAP_label_transfer_refSCShirmer_querySC_robust.pdf",width = 10,height = 8)
ggsave("../../out/plot/UMAP_label_transfer_refSCShirmer_querySC_robust.png",width = 10,height = 8,bg="white")
...
ggsave("../../out/plot/histo_label_transfer_refSCShirmer_querySC_cluster.pdf",width = 3,height = 4)
...
query_transfer@meta.data %>%
  ...
  theme_bw() +
  geom_vline(xintercept = 0.70,linetype="dashed",col="red",alpha=0.5)
ggsave("../../out/plot/histo_label_transfer_refSCShirmer_querySC_predictedID.pdf",width = 3,height = 4)
...
pdf("../../out/plot/heatmap_label_transfer_refSCShirmer_querySC_raw.pdf",height = 6,width = 6)
...
pdf("../../out/plot/heatmap_label_transfer_refSCShirmer_querySC_robust.pdf",height = 6,width = 6)
