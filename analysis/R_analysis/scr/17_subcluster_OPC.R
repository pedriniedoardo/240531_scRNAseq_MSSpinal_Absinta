# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the OPC cells from the WM+CX dataset
...
sobj_subset <- subset(sobj,subset = cell_id %in% c("OPC"))
...
saveRDS(sobj_total_h,"../../out/object/17_OPC_subcluster_HarmonySample.rds")
