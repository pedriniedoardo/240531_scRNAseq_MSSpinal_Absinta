...
sobj_subset <- subset(sobj,subset = cell_id %in% c("T CELLS","B CELLS"))
...
saveRDS(sobj_total_h,"../../out/object/17_LYM_subcluster_HarmonySample.rds")
