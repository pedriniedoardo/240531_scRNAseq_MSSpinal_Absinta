...
sobj_subset <- subset(sobj,subset = cell_id %in% c("IMMUNE"))
...
DimPlot(sobj_total_h,raster = T,label = T,group.by = "dataset")
DimPlot(sobj_total_h,raster = T,label = T,group.by = "location")
DimPlot(sobj_total_h,raster = T,group.by = "dataset",label = T,split.by = "location")

# sobj_total_h <- readRDS("../../out/object/data.combined_harmonySkipIntegration_AllSoupX_01000_6000_15.rds")
saveRDS(sobj_total_h,"../../out/object/17_IMMUNE_subcluster_HarmonySample.rds")
