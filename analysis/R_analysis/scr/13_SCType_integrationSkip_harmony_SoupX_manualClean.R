...
scobj <- readRDS("../../out/object/manualClean/data.combined_harmonySkipIntegration_AllSoupX_00500_07000_05_Annotation.rds")
...
ggsave("../../out/plot/manualClean/Dotplot_SCTypeClusterAnnotation_harmonySkipIntegration_AllSoupX_00500_07000_05_res0.2.pdf",height = 12,width = 12)
...
pdf("../../out/plot/manualClean/Heatmap_SCTypeClusterAnnotation_harmonySkipIntegration_AllSoupX_00500_07000_05_res0.2.pdf",width = 10,height = 8)
...
df_score_cluster %>%
  ...
  theme(strip.background = element_blank(),
        axis.text.x = element_text(hjust = 1,angle = 90))
ggsave("../../out/plot/manualClean/Dotplot_SCTypeAnnotationCluster_harmonySkipIntegration_AllSoupX_00500_07000_05_res0.2.pdf",height = 8,width = 15)
...
pdf("../../out/plot/manualClean/Heatmap_SCTypeAnnotationCluster_harmonySkipIntegration_AllSoupX_00500_07000_05_res0.2.pdf",width = 10,height = 6)
...
df_meta_full <- left_join(df_meta,df_score_cluster_top,c("RNA_snn_res.0.2"="cluster"))
...
ggsave("../../out/plot/manualClean/UMAPSCTypeRNN01_harmonySkipIntegration_AllSoupX_00500_07000_05_res0.2.pdf",width = 8,height = 5)
...
saveRDS(scobj,"../../out/object/manualClean/data.combined_harmonySkipIntegration_AllSoupX_00500_07000_05_AnnotationSCType.rds")
