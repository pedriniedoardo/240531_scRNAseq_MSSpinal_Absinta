...
# run azimuth -------------------------------------------------------------
# read in the query
query <- LoadFileInput("../../out/object/analysis_R45_pixi/28_LYM_subcluster_HarmonySample_diet.rds")
...
query <- RunAzimuth(query, reference = "renv/library/linux-rocky-9.5/R-4.5/x86_64-conda-linux-gnu/pbmcref.SeuratData/azimuth/")

# can also be passed
# query <- RunAzimuth(query, reference = "humancortexref")
saveRDS(query,"../../out/object/analysis_R45_pixi/28_Azimuth_LYM_subcluster_HarmonySample.rds")
...
sample_id <- "LYM_subcluster_HarmonySample"
reference_id <- "HumanPBMCRef"

# define the cluster covariate
cluster_query <- "RNA_snn_res.0.4"

# condition splitting covariate
var_split <- "diagnosis_short"
...
query@reductions$ref.umap@cell.embeddings %>% 
  ...
  write_tsv(paste0("../../out/table/analysis_R45_pixi/28_",sample_id,"_CoordUMAP_Azimuth_",reference_id,"_",class,".tsv"))

# save the new annotation from azimuth
query@meta.data %>% 
  data.frame() %>% 
  # rownames_to_column("barcode") %>% 
  write_tsv(paste0("../../out/table/analysis_R45_pixi/28_",sample_id,"_meta_Azimuth_",reference_id,"_",class,".tsv"))

# custome plots threshold 0.75 --------------------------------------------
# costume visualization
UMAP_query <- read_tsv(paste0("../../out/table/analysis_R45_pixi/28_",sample_id,"_CoordUMAP_Azimuth_",reference_id,"_",class,".tsv"))
meta_query <- read_tsv(paste0("../../out/table/analysis_R45_pixi/28_",sample_id,"_meta_Azimuth_",reference_id,"_",class,".tsv")) %>%
  mutate(
...
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_score_075.pdf"),height = 4,width = 4)
...
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_ridges_score_075.pdf"),height = 5,width = 4)
...
pdf(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_",cluster_query,"_Heatmap_score_075.pdf"),height = 4,width = 5)
...
pdf(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_",cluster_query,"_HeatmapFilter_score_075.pdf"),height = 4,width = 5)
...
UMAP_ref <- read_tsv("../../out/table/analysis_R45_pixi/azimuth_pbmcref_CoordUMAP.tsv")

# umap coordinates of the query object
UMAP_ref2 <- read_tsv(paste0("../../out/table/analysis_R45_pixi/28_",sample_id,"_CoordUMAP_Azimuth_",reference_id,"_",class,".tsv"))

# original metadata of the reference object
meta_ref <- read_tsv("../../out/table/analysis_R45_pixi/azimuth_pbmcref_Metadata.tsv") %>%
...
ggsave(paste0("../../out/plot/analysis_R45_pixi/",reference_id,"_",class,"_label.pdf"),width = 8,height = 6)
...
ggplot()+
  ...
  theme_cowplot()
ggsave(paste0("../../out/plot/analysis_R45_pixi/",reference_id,"_",class,"_Nolabel.pdf"),width = 8,height = 6)
...
ggplot()+
  ...
  theme_cowplot()
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAP_Cluster_075.pdf"),height = 6,width = 7)
...
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAP_Cluster_slit_075.pdf"),height = 6,width = 15)
...
ggplot()+
  ...
  theme_cowplot()
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAP_class_075.pdf"),height = 6,width = 7)
...
ggplot()+
  ...
  facet_wrap(~var_split,ncol=4)+
  theme(strip.background = element_blank())
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAP_class_split_075.pdf"),height = 6,width = 14)
...
sobj <- readRDS("../../out/object/analysis_R44/27_LYM_subcluster_HarmonySample.rds")
...
ggplot()+
  ...
  theme_cowplot()
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAPinverse_class_075.pdf"),height = 6,width = 7)
...
ggplot()+
  ...
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave(paste0("../../out/plot/analysis_R45_pixi/28_",sample_id,"_",class,"_",reference_id,"_UMAPinverse_class_split_075.pdf"),height = 6,width = 14)
