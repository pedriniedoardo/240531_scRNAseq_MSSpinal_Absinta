# AIM ---------------------------------------------------------------------
# run GSEA on the table of DE from sc analysis. use as ranking the signed pvalue as recommended here:
...
df_tables_GSEA_all %>%
  write_tsv(paste0("../../out/table/analysis_R44/32_df_table_GSEA_KEGG_rankSigLogPval_","IMMUNE",".tsv"))
...
# save the table
df_tables_GSEA_all_non_redundant %>%
  write_tsv(file = paste0("../../out/table/analysis_R44/32_df_table_GSEA_KEGG_nonredundant_rankSigLogPval_","IMMUNE",".tsv"))
...
ggsave(paste0("../../out/plot/analysis_R44/32_GSEA_unbiased_KEGG_nonredundant_rankSigLogPval_","IMMUNE",".pdf"),width = 15,height = 10)
...
df_tables_GSEA_all %>%
  ...
  geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)+
  geom_hline(yintercept = -log(0.05),col="gray",linetype="dashed")
ggsave(paste0("../../out/plot/analysis_R44/32_GSEA_unbiased_KEGG_rankSigLogPval_","IMMUNE",".pdf"),width = 15,height = 9)
