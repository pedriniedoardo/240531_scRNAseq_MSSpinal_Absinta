# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the LYMPHOCYTES cells from 
...
sobj_subset <- subset(sobj,subset = cell_id %in% c("B CELLS","T CELLS"))
...
saveRDS(sobj_total_h,"../../out/object/analysis_R44/27_LYM_subcluster_HarmonySample.rds")
