# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the ASTRO cells from the spinal cord dataset
...
saveRDS(sobj_total_h,"../../out/object/analysis_R44/27_ASTRO_subcluster_HarmonySample.rds")
