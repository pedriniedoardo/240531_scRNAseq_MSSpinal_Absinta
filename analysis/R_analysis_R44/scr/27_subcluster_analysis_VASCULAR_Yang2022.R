# AIM ---------------------------------------------------------------------
# the aim is to plot the data after integration. in particular to plot the sognature score for Yang cell assignament.
...
# load the signatures defined by Martina for the VAS cell types
...
list_sig <- c(sig01_02,sig02_02,sig03_02)


# df_LUT <- data.frame(type = c("homeostatic","MIMs foamy","MIMs iron","DC_2","DC_6","stressed MG"),
#                      cluster = c(0,1,8,2,6,3))
# 
# list_sig <- read_csv("../../data/signatures/Signature_IMM_subset_Yang2022.csv") %>%
...
ggsave("../../out/plot/analysis_R44/27_UMAP_SigYang2022_VAS_subset_highres.pdf",width = 27,height = 22)
...
mat_custom_avg %>%
  ...
  write_tsv("../../out/table/analysis_R44/27_tableScaled_SigYang2022_res0.1_VAS_subset_highres.tsv")

df_custom %>%
  write_tsv("../../out/table/analysis_R44/27_tableUnScaled_SigYang2022_res0.1_VAS_subset_highres.tsv")

pdf("../../out/plot/analysis_R44/27_heatmap_SigYang2022_res0.1_VAS_subset_highres.pdf",width = 9,height = 5)
...
pdf("../../out/plot/analysis_R44/27_heatmap_SigYang2022_res0.1_VAS_subset_highres2.pdf",width = 10,height = 5)
...
mat_custom_avg %>%
  rownames_to_column("signatures") %>%
  write_tsv("../../out/table/analysis_R44/27_tableScaled_SigYang2022_res0.4_VAS_subset_highres.tsv")

df_custom %>%
  write_tsv("../../out/table/analysis_R44/27_tableUnScaled_SigYang2022_res0.4_VAS_subset_highres.tsv")

pdf("../../out/plot/analysis_R44/27_heatmap_SigYang2022_res0.4_VAS_subset_highres.pdf",width = 10,height = 10)
draw(hm01,heatmap_legend_side = "left",padding = unit(c(2, 2, 2, 80), "mm"))
dev.off()
...
pdf("../../out/plot/analysis_R44/27_heatmap_SigYang2022_res0.4_VAS_subset_highres2.pdf",width = 10,height = 5)
draw(hm02,heatmap_legend_side = "left",padding = unit(c(4, 2, 2, 80), "mm"))
dev.off()
