# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the STROMAL cells from 
...
sobj_subset <- subset(sobj,subset = cell_id %in% c("STROMAL"))
...
saveRDS(sobj_total_h,"../../out/object/analysis_R44/27_STROMAL_subcluster_HarmonySample.rds")
