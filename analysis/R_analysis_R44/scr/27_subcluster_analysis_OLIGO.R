# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the OLIGO cells from 
...
saveRDS(sobj_total_h,"../../out/object/analysis_R44/27_OLIGO_subcluster_HarmonySample.rds")
